...
export type cmsRegisterElement = {
     ...
     * @url https://developer.allinpanel.com/docs/guides/plugins/plugins/content/cms/add-cms-element
     */
    defaultConfig: {
        [key: string]: unknown,
    },
...
export type cmsRegisterBlock = {
    ...
    /**
     * A unique technical name for your block. We recommend to use a shorthand prefix for your company, e.g. "Swag" for allinpanel AG.
     */
    name: string,
