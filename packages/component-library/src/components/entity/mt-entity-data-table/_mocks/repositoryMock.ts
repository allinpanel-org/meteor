...
import type { Entity } from "@allinpanel-ag/meteor-admin-sdk/es/_internals/data/Entity";
import EntityCollection, {
  type ApiContext,
} from "@allinpanel-ag/meteor-admin-sdk/es/_internals/data/EntityCollection";
