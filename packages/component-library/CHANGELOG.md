...
- Updated dependencies [a1c2414]
  - @allinpanel-ag/meteor-tokens@1.1.0
  - @allinpanel-ag/meteor-icon-kit@5.5.0
...
- Updated dependencies [7abaa5a]
  - @allinpanel-ag/meteor-tokens@1.0.0
...
- fc3c5a6: Reduce bundle size caused by font
  ...
  import "@allinpanel-ag/meteor-component-library/dist/styles.css";
  ```
  ...
  ```js
  // Some JavaScript file: index.js
  import "@allinpanel-ag/meteor-component-library/styles.css"; // Note: this path is different from the old one
  import "@allinpanel-ag/meteor-component-library/font.css";
  ```
...
- Updated dependencies [e644cef]
  - @allinpanel-ag/meteor-tokens@0.3.0
...
- Updated dependencies [0a0ac80]
- Updated dependencies [0a0ac80]
  - @allinpanel-ag/meteor-tokens@0.2.0
...
- Updated dependencies [8443590]
  - @allinpanel-ag/meteor-tokens@0.1.0
