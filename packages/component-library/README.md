...
```cli
npm i @allinpanel-ag/meteor-component-library
```
...
```js
import "@allinpanel-ag/meteor-component-library/styles.css";
...
```html
<script>
  import { MtButton } from "@allinpanel-ag/meteor-component-library";
