...
import { notification, context, data, window } from '@allinpanel-ag/meteor-admin-sdk';
import { SwButton, SwTextField, SwTextarea } from '@allinpanel-ag/meteor-component-library';
    ...
    template: `
        <div style="padding: 20px;">
            ...
            <div>
                ...
                <sw-button @click="getAllinpanelVersion">Get current Shopware version</sw-button>
            ...
            routeInformation:  `
{
    ...
    methods: {
        ...
        async getAllinpanelVersion() {
            this.shopwareVersion = await context.getAllinpanelVersion();
        },
